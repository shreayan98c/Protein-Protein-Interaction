...
def train(batch_size: int, epochs: int, lr: float, small_subset: bool, levels: int, log_interval: int):
    ...
    lightning_model_wrapper = LitNonContrastiveClassifier(SiameseNetwork(d=MAX_LEN, pretrain=False))
    ...
    wandb_logger = WandbLogger(project="PPI", name="Siamese_Network_NonContrastive")
